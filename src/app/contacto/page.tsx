            ...
            <div className="flex-1 lg:flex lg:items-center lg:-mx-6">
              <div className="text-white lg:w-1/2 lg:mx-6">
                ...
                <p className="max-w-xl mt-6">
                  Estamos acá para ayudarte a llevar tu marca al próximo nivel.
                  Si tenés alguna pregunta, querés más información sobre
                  nuestros servicios o querés charlar sobre un nuevo proyecto,
                  no dudes en comunicarte con nosotros. Nos encantaría saber de
                  vos y ver cómo podemos trabajar juntos!
                </p>
                ...
                <div className="w-full px-8 py-10 mx-auto overflow-hidden bg-white shadow-2xl rounded-xl lg:max-w-xl">
                  ...
                  <form className="mt-6">
                    ...
                    <div className="w-full mt-6">
                      ...
                      <textarea
                        className="block w-full h-32 px-5 py-3 mt-2 text-neutral-700 placeholder-neutral-400 bg-white border border-neutral-200 rounded-md md:h-48  focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40  focus:outline-none focus:ring"
                        placeholder="Mensaje"
                      ></textarea>
                    </div>

                    <button className="w-full px-6 py-3 mt-6 text-sm font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-[#2D29C2] rounded-md hover:bg-blue-500 focus:outline-none focus:ring focus:ring-blue-400 focus:ring-opacity-50">
                      Enviar Mensaje
                    </button>
                  </form>
                </div>
